							...
							<div id="list-view" class="tab-pane fade active show col-lg-12">
								<div class="card">
									<div class="card-header">
										...
										<a href="/register" class="btn btn-primary">+ Ajouter</a>
									</div>
									<div class="card-body">
													...
													<tr>
                                                        ...
                                                        <td>
                                                             @if($client->photo_profil)
                                                                 <img class="rounded-circle" width="35" src="{{ Storage::url($client->photo_profil) }}" alt="Photo de profil">
                                                            @else
                                                                  <img class="rounded-circle" width="35" src="{{ asset('images/default-photo.jpg') }}" alt="Photo de profil par défaut">
                                                              @endif
                                                        </td>

														<td>
															<a href="{{ route('clients.edit', $client->id) }}" class="btn btn-sm btn-primary"><i class="la la-pencil"></i>Voir</a>
