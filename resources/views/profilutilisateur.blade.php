                ...
                <div class="row page-titles mx-0">
                    <div class="col-sm-6 p-md-0">
                        <div class="welcome-text">
                            ...
                            <h4>A propos de l'Utilisateurs</h4>
                        @if (session('status'))
                    ...
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="javascript:void(0);">a propos de l'utilisateur</a></li>
                        </ol>
                    </div>
                </div>
								...
								<div class="card">
									<div class="text-center p-3 overlay-box" style="background-image: url(/images/big/img1.jpg);">
										...
										<h3 class="mt-3 mb-1 text-white">
                                            {{ Auth::guard('client')->user()->nom }} {{ Auth::guard('client')->user()->prenom }}
                                        </h3>
									</div>
									...
									<div class="card-body pb-0">
										...
										<ul class="list-group list-group-flush">
											<li class="list-group-item d-flex px-0 justify-content-between">
												<strong>Nom</strong>
												<span class="mb-0">{{ Auth::guard('client')->user()->nom }}</span>
											</li>
											<li class="list-group-item d-flex px-0 justify-content-between">
												<strong>Prénom:</strong>
												<span class="mb-0">{{ Auth::guard('client')->user()->prenom }}</span>
											</li>
											<li class="list-group-item d-flex px-0 justify-content-between">
												<strong>Email</strong>
												<span class="mb-0">{{ Auth::guard('client')->user()->email }}</span>
											</li>
											<li class="list-group-item d-flex px-0 justify-content-between">
												<strong>Téléphone</strong>
												<span class="mb-0">{{ Auth::guard('client')->user()->mobile }}</span>
											</li>
										</ul>
									</div>
                                    ...
                                    <div class="custom-tab-1">
                                        ...
                                        <div class="tab-content">
                                            <div id="about-me" class="tab-pane fade active show">
                                                <form action="/update-profile-traitement" method="post" enctype="multipart/form-data">
                                                    @csrf
                                                    <div class="row">
                                                        <div class="col-lg-6 col-md-6 col-sm-12">
                                                            <div class="form-group">
                                                                <label class="form-label">Nom</label>
                                                                <input type="text" class="form-control @error('nom') is-invalid @enderror" name="nom" value="{{ $client->nom }}">
                                                                @error('nom')
                                                        ...
                                                        <div class="col-lg-6 col-md-6 col-sm-12">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control @error('prenom') is-invalid @enderror" name="prenom" value="{{ $client->prenom }}">
                                                                @error('prenom')
                                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                                @enderror
                                                            </div>
                                                        ...
                                                        <div class="col-lg-6 col-md-6 col-sm-12">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control @error('mobile') is-invalid @enderror" name="mobile" value="{{ old('mobile', $client->mobile) }}">
                                                                @error('mobile')
                                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                                @enderror
                                                            </div>
                                                        ...
                                                        <div class="col-lg-6 col-md-6 col-sm-12">
                                                            <div class="form-group fallback w-100">
                                                                ...
                                                                <input type="file" class="dropify @error('photo_profil') is-invalid @enderror" data-default-file="{{ $client->photo_profil ? asset('storage/'.$client->photo_profil) : '' }}" name="photo_profil">
                                                                @error('photo_profil')
                                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                                @enderror
                                                            </div>
