                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 col-md-6 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control @error('nom') is-invalid @enderror" name="nom" value="{{ old('nom', $client->nom) }}">
                                                @error('nom')
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control @error('prenom') is-invalid @enderror" name="prenom" value="{{ old('prenom', $client->prenom) }}">
                                                @error('prenom')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control @error('role') is-invalid @enderror" name="role">
                                                    ...
                                                    <option value="user" {{ old('role', $client->role) == 'user' ? 'selected' : '' }}>User</option>
                                                </select>
                                                @error('role')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control @error('etat') is-invalid @enderror" name="etat">
                                                    ...
                                                    <option value="bloque" {{ old('etat', $client->etat) == 'bloque' ? 'selected' : '' }}>Bloqué</option>
                                                </select>
                                                @error('etat')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12">
                                            <div class="form-group">
                                              ...
                                              @if($client->photo_profil)
                                                  <img src="{{ Storage::url($client->photo_profil) }}" alt="Photo de {{ $client->nom }}" width="100" style="border-radius: 50%;">
                                              @else
                                        ...
                                        <div class="col-lg-6 col-md-12 col-sm-12">
                                          <a href="/delete-utilisateur/{{$client->id}}" class="btn btn-danger" onclick="return confirm('Êtes-vous sûr de vouloir supprimer cet Utilisateur ?')">Supprimer</a>
                                        </div>
                                    </div>
                                </form>
