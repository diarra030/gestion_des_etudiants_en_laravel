				...
				<div class="row">
					<div class="col-xl-12 col-xxl-12 col-sm-12">
                        <div class="card">
							...
							<div class="card-body">
                                <form Action="/ajouter/traitement" method="POST" class=" row form mx-auto" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class=" col-md-6 mb-3">
                                      ...
                                      <input type="text" class="form-control @error('prenom') is-invalid @enderror" id="exampleInputPassword1" name="prenom">
                                      <div class="invalid-feedback">
                                        Champs obligatoire
                                      </div>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                      <label for="exampleInputPassword2" class="form-label">Classe</label>
                                      <input type="text" class="form-control @error('classe') is-invalid @enderror" id="exampleInputPassword2" name="classe" >
                                      <div class="invalid-feedback">
                                        Champs obligatoire
                                      </div>
                                    </div>
                                    ...
                                    <br>
                                    <button type="submit" class="btn btn-primary">Enregistrement de l Etudiant</button>
